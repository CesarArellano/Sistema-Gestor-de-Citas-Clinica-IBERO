...
public class Paciente{
    public String NombrePaciente, APaternoPaciente, AMaternoPaciente, CorreoPaciente, TContacto;
    private int EdadPaciente;

    public Paciente(String NombrePaciente, String APaternoPaciente, String AMaternoPaciente, String CorreoPaciente, String TContacto){
